...
namespace TagEkyc.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260810120000_Tip88C1B2R3VerifiedCiphertextStaging")]
    partial class Tip88C1B2R3VerifiedCiphertextStaging
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TagEkyc.Infrastructure.Persistence.Entities.RawExportSourceHeadRow", b =>
                {
                    ...
                    b.ToTable("raw_export_source_head", "tagekyc", t =>
                        {
                            t.HasCheckConstraint("ck_raw_export_source_head_values", "\"CustodyState\" IN ('Reserved','Staged') AND \"ReservationRevision\" >= 1 AND \"Fence\" >= 1");
                        });
                });
