...
namespace TagEkyc.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260807120000_Tip88C1B2R2DurableCustodyEncryption")]
    partial class Tip88C1B2R2DurableCustodyEncryption
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TagEkyc.Infrastructure.Persistence.Entities.RawExportSourceHeadRow", b =>
                {
                    ...
                    b.ToTable("raw_export_source_head", "tagekyc", t =>
                        {
                            t.HasCheckConstraint("ck_raw_export_source_head_values", "\"CustodyState\" = 'Reserved' AND \"ReservationRevision\" >= 1 AND \"Fence\" >= 1");
                        });
                });
