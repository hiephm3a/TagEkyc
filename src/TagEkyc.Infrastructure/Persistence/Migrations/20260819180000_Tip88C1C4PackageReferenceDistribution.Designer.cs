...
namespace TagEkyc.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260819180000_Tip88C1C4PackageReferenceDistribution")]
    partial class Tip88C1C4PackageReferenceDistribution
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("raw_export_recipient_key_registrations", "tagekyc", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_raw_export_recipient_key_registration_sparse", "(\"State\" = 'Active' AND \"RevokedAtUtc\" IS NULL) OR (\"State\" = 'Revoked' AND \"RevokedAtUtc\" IS NOT NULL)");
                        });
                });
