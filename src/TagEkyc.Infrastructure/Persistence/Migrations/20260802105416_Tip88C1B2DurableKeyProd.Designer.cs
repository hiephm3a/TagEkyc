...
namespace TagEkyc.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260802105416_Tip88C1B2DurableKeyProd")]
    partial class Tip88C1B2DurableKeyProd
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("raw_export_attempt_key_preparation_events", "tagekyc", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_raw_export_attempt_key_event_text", """
                    ...
                    b.ToTable("raw_export_attempt_key_reservations", "tagekyc", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_raw_export_attempt_key_reservation_text", """
                    ...
                    b.ToTable("raw_export_key_provider_operations", "tagekyc", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_raw_export_key_provider_operation_text", """
                                "KeyProviderId"=btrim("KeyProviderId") AND "KeyProviderId"=normalize("KeyProviderId",NFC)
                                  AND octet_length("KeyProviderId") BETWEEN 1 AND 512 AND "KeyProviderId" !~ '[\x00-\x1f\x7f]'
