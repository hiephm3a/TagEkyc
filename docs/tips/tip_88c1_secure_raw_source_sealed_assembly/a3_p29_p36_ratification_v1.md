...
A3-Reviewed-Manifest-SHA256: B5D25EAB78CCD42C69F93E4AC768CBB887724C6F540AEAB192C927E15BCCB671
...
The revision-19 evidence-only successor records the independently reviewed bounded post-seal recovery correction through exact HEAD `43ec4b58fe0096c440f9dbe9af1e7829ef5bd6a2`. The retained package proves the four original recovery defects and the subsequent race, NULL-bypass, post-lock lease, starvation, and legacy-finalize capability corrections with discriminating SQL/runtime mutations, restored 25/25 runtime gates, and a fully classified 101/101 failed-run census. The final C116 clarification remains strict against `PreparationConflict` while replacing a label-only expectation with durable database assertions for single finalization, zero abort, unchanged attempt fencing, and no duplicate preparation. Both independent reviewers reported PASS with no actionable finding. Process kill/restart durability remains unclaimed, C125 remains a separate item, and site-qualification Layer 2 remains paused. This successor changes no product, SDK, partition, ledger, scope decision, ownership table, authority-open count, approved topology, site policy, or previously ratified semantics.
