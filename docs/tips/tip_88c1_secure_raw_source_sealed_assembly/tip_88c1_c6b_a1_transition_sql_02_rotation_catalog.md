...
**Consumed operation master:** SHA-256 `B1E3F320C32691756DACEF5A206B6D0303E811377B7304623C43C56ECBEAC277`  
**Consumed literal DDL master:** SHA-256 `86B4B9960F943A86B6178FA548945A99D90057D61D4ED631151D447D844113D7`  
...
BEGIN
 ...
 RETURN QUERY SELECT 'Applied',new_rotation_id,p_agent,p_installation,p_credential,p_generation,'Active',1,p_expires;
END $f$;
...
BEGIN
 ...
 RETURN QUERY SELECT 'Applied',p_credential,next_generation,p_candidate_key,p_thumbprint,1,i."Revision",a."Revision";
END $f$;
