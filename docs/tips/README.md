...
| TIP-50 | `tip_50_provider_neutral_evidence_authorization_packet_planning/` | [`tip_50_planning_brief_v0_1.md`](tip_50_provider_neutral_evidence_authorization_packet_planning/tip_50_planning_brief_v0_1.md) - draft planning brief; docs-only / provider-neutral evidence authorization packet framework planning; defines common packet fields, packet type templates, dependency ordering, and authorization decision matrix for future reviewed packet work only; approves no actual packet; preserves deny-by-default posture for provider-specific evidence collection, raw payload collection/persistence, artifact/raw evidence persistence, restricted artifact access, persistence/access/runtime, HLD/LLD patching, and provider/storage/resolver/tool selection; preserves `GOV-001` as unresolved/carry-forward and `ART-001` through `ART-009` as packet-gated planning requirements only; authorizes no readiness/legal/audit/security/production/certification/capability claim |
