...
- Recorded that package completeness cannot be claimed if required object classes are missing, unresolved, expired, inaccessible, unauthorized, orphan-suspected, quarantined, not reviewed, or outside accepted scope.
